...
public class Schema {
    ...
    public static class OpenHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE IF NOT EXISTS folders (_id INTEGER PRIMARY KEY AUTOINCREMENT, folder BIGINT UNIQUE, name TEXT, private TEXT, archived TEXT, ord TEXT)");
